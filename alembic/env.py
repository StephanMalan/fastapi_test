...
# here we allow ourselves to pass interpolation vars to alembic.ini fron the host env
section = config.config_ini_section
assert getenv("POSTGRES_USER") is not None
assert getenv("POSTGRES_PASSWORD") is not None
assert getenv("POSTGRES_DB") is not None
